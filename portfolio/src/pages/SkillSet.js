export function initSkillSet(container) {
  ...
  section.innerHTML = `
    <div class="max-w-3xl text-center px-4">
      <h2 class="text-4xl sm:text-6xl font-black tracking-tight mb-6 text-neutral-950 dark:text-white">Skill Set</h2>
      <p class="text-lg text-neutral-600 dark:text-neutral-400">ここにスキルセットの内容が入ります。</p>
    </div>
  `;
